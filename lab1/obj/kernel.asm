...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200454:	bc870713          	addi	a4,a4,-1080 # 80204018 <PRINT_NUM>
    80200458:	431c                	lw	a5,0(a4)
                if (PRINT_NUM == 10)
    8020045a:	46a9                	li	a3,10
                PRINT_NUM++;
    8020045c:	0017861b          	addiw	a2,a5,1
    80200460:	c310                	sw	a2,0(a4)
                if (PRINT_NUM == 10)
    80200462:	fcd616e3          	bne	a2,a3,8020042e <interrupt_handler+0x6a>
}
...
void exception_handler(struct trapframe *tf) {
    ...
    802004a0:	bd1ff0ef          	jal	ra,80200070 <cprintf>
            // 采用0x%016llx格式化字符串，用于打印16位十六进制数，这个位置是异常指令的地址,以tf->epc作为参数。
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005f4:	a3878793          	addi	a5,a5,-1480 # 80201028 <etext+0x608>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200650:	a10a8a93          	addi	s5,s5,-1520 # 8020105c <etext+0x63c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200658:	be4b8b93          	addi	s7,s7,-1052 # 80201238 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008ae:	7ae60613          	addi	a2,a2,1966 # 80201058 <etext+0x638>
    ...
    802008c0:	78c60613          	addi	a2,a2,1932 # 80201048 <etext+0x628>
    ...
    802008d2:	77240413          	addi	s0,s0,1906 # 80201040 <etext+0x620>
    ...
    8020095c:	6e840413          	addi	s0,s0,1768 # 80201040 <etext+0x620>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    80200972:	6d3a0a13          	addi	s4,s4,1747 # 80201041 <etext+0x621>
